...
const InstructionsSharpTest = () => {
  ...
  useEffect(() => {
    // Check Redux state instead of local storage
    if (seenInstructions) {
      setCurrentContent(4); // Jump to abbreviated content
    }
  }, [seenInstructions]);
            ...
            <div className="abbreviated">
              ...
              <div>
                <img
                  ...
                  src="./instructionscontrasttest.svg"
                  width={200}
                  height={200}
                  alt="circle"
                ></img>
        ...
        case 0:
          return (
            <div className="consent">
              ...
              <h1>
                <b>
                  Před zahájením si tyto informace prosím přečtěte a přijměte
                  je.
                </b>
              </h1>
              <p>
                Toto online vyšetření zraku slouží k tomu, aby vám poskytlo
                první posouzení vašeho aktuálního zraku. Nejedná se o lékařské
                vyšetření a nenahrazuje oční péči poskytovanou odborným lékařem.
                Není určeno k diagnóze onemocnění či zmírnění, léčbě či prevenci
                nemoci. Toto vyšetření vám má pouze poskytnout obecný přehled o
                vaší zrakové ostrosti a informaci, zda je pro vás vhodné
                absolvovat odborné vyšetření očí. Doporučujeme, abyste si oči
                nechali kontrolovat odborným lékařem každé dva roky či dříve,
                pokud si povšimnete změn svého zraku. Společnost Erste Optik
                s.r.o. ani žádná jiná společnost, která náleží do skupiny
                spřátelných optik, nepřijímá odpovědnost za škody či následky
                plynoucí z online vyšetření zraku a/nebo poskytnutých informací.
              </p>
              <button className="defaultButton" onClick={handleNext}>
                Souhlasím
              </button>
                ...
                <div className="card-container">
                  ...
                  >
                    <p>
                      ...
                      kartu. Tak si nastavíte velikost stínítka své obrazovky
                      pro daný test. Ničeho se nebojte, tento test je zdarma.
                      Nechceme tímto způsobem shromažďovat žádné informace.
                    </p>
                  </div>
                </div>
