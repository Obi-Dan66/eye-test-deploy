...
const InstructionsSharpTest = () => {
  ...
  }, []); // Keeping the dependency array empty

  useEffect(() => {
    console.log(
      "Component - Initial Seen Instructions from Redux:",
      seenInstructions
    );
    if (seenInstructions) {
      setCurrentContent(4); // or other logic for abbreviated content
    }
  }, [seenInstructions]);

  const handleNext = () => {
    console.log("Component - Current Content before Next:", currentContent);
    const totalContents = 7; // Assuming there are 8 content items
    const nextContent = (currentContent + 1) % totalContents;
    setCurrentContent(nextContent);
    console.log("Component - Current Content after Next:", nextContent);

    if (nextContent === 0 && currentContent === totalContents - 1) {
      console.log(
        "Component - Wrapping from last to first, setting seenInstructions to true"
      );
      dispatch(setSeenInstructions(true));
    }
  };

  const handleNextAbbreviatedContent = () => {
    const totalAbbreviatedContents = 3; // Total number of abbreviated content items
    const nextContent = (currentContent + 1) % totalAbbreviatedContents;
    setCurrentContent(nextContent);

    // Additional logic specific to abbreviated content can go here
  };

  const startTest = () => {
    console.log("Component - Start Test Triggered");
    navigate("/test-zrakove-ostrosti");
    dispatch(setSeenInstructions(true));
    console.log("Dispatched - setSeenInstructions with true");
  };
      ...
      case 0:
        return (
          <div className="consent">
            ...
            <p>
              Toto online vyšetření zraku slouží k tomu, aby vám poskytlo první
              posouzení vašeho aktuálního zraku. Nejedná se o lékařské vyšetření
              a nenahrazuje oční péči poskytovanou odborným lékařem. Není určeno
              k diagnóze onemocnění či zmírnění, léčbě či prevenci nemoci. Toto
              vyšetření vám má pouze poskytnout obecný přehled o vaší zrakové
              ostrosti a informaci, zda je pro vás vhodné absolvovat odborné
              vyšetření očí. Doporučujeme, abyste si oči nechali kontrolovat
              odborným lékařem každé dva roky či dříve, pokud si povšimnete změn
              svého zraku. Společnost Erste Optik s.r.o. ani žádná jiná
              společnost, která náleží do skupiny spřátelných optik, nepřijímá
              odpovědnost za škody či následky plynoucí z online vyšetření zraku
              a/nebo poskytnutých informací.
            </p>
              ...
              >
                ...
                >
                  ...
                  <g mask="url(#mask0_1769_17326)">
                    ...
                    ></path>
                    <path
                      d="M37.5616 38.8369C37.1711 38.4464 36.5379 38.4464 36.1474 38.8369L29.7834 45.2009C29.3929 45.5914 29.3929 46.2246 29.7834 46.6151C30.1739 47.0056 30.8071 47.0056 31.1976 46.6151L36.8545 40.9582L42.5113 46.6151C42.9019 47.0056 43.535 47.0056 43.9256 46.6151C44.3161 46.2246 44.3161 45.5914 43.9256 45.2009L37.5616 38.8369ZM37.8545 69.5725L37.8545 39.544L35.8545 39.544L35.8545 69.5725L37.8545 69.5725Z"
                      fill="#0072EF"
                    ></path>
                  </g>
                </svg>
          ...
          <div className="card-container-wrapper">
            ...
            <div className="page-container">
              <div className="card-container">
                ...
                >
                  <p>
                    Můžete použít jakýkoliv běžný průkaz, kreditní či bankovní
                    kartu. Tak si nastavíte velikost stínítka své obrazovky pro
                    daný test. Ničeho se nebojte, tento test je zdarma. Nechceme
                    tímto způsobem shromažďovat žádné informace.
                  </p>
                </div>
              </div>
            ...
            <h1>
              <b>Abyste nastavili velikost obrazovky</b>, umístěte kartu na
              rámeček a k vyrovnání použijte posuvník.
            </h1>
            <button className="defaultButton" onClick={handleNext}>
              Další krok
            </button>
        ...
        return (
          <div className="abbreviated">
            ...
            <svg
              ...
              width="264px"
              height="172px"
              viewBox="0 0 160 104.825"
              alt=""
            >
              <path
                d="M90.8 26.246s2.771-10.062 6.18-13.833 9.866-10.113 18.006-11 16.148.314 20.644 3.255 10.18 7.727 11.821 14.391.336 14.821-1.62 19.825-5.587 10.675-7.217 12.014a11.8 11.8 0 01-2.984 1.848l-5.767-13.861-3.716-9.515-5.863 7.776-1.175-1.646-.943-7.337-2.78-7.659-1.484-1.445-9.726 3.905z"
                fill="none"
              ></path>
              <path d="M19 92.112H7v-80h12zm-10-2h8v-76H9z"></path>
              <rect
                width="2"
                height="10"
                transform="translate(12 92.112)"
              ></rect>
              <rect
                width="26"
                height="2"
                transform="translate(0 102.112)"
              ></rect>
              ...
              <g fill="#0072EF" transform="translate(2 2)">
                <rect
                  width="6"
                  height="2"
                  transform="translate(28 48.086)"
                ></rect>
                <rect
                  width="6"
                  height="2"
                  transform="translate(38 48.086)"
                ></rect>
                <rect
                  width="6"
                  height="2"
                  transform="translate(58 48.086)"
                ></rect>
                <rect
                  width="6"
                  height="2"
                  transform="translate(68 48.086)"
                ></rect>
              </g>
  ...
  const getAbbreviatedContent = (contentIndex) => {
        ...
        return (
          <div className="abbreviated">
            ...
            <button
              ...
              onClick={handleNextAbbreviatedContent}
            >
              Další krok
            </button>
          </div>
  ...
  return (
    <div>
      {seenInstructions
        ? getAbbreviatedContent(currentContent)
